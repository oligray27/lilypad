...
const VIEW_SIZE = {
  loginView: { width: 680, height: 320 },
  mainView: { width: 680, height: 320 },
  mappingsView: { width: 680, height: 590 },
...
function showView(id, heightOrOpts) {
  ...
  const spec = VIEW_SIZE[id] || { width: 680, height: 590 };
  let w = spec.width;
  let h = spec.height;
...
function showPostPlay(data) {
  ...
  showView('sessionView', { height: isLive ? 255 : 165 });
}
